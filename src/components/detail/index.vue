            ...
            <div id="__layout">
              <div id="juejin">
                ...
                <div class="view-container" data-v-8ec00994 data-v-48f7b280>
                  <div class="main-header-box" data-v-8ec00994></div>
                  <main
                  ...
                  >
                    <div class="article-suspended-panel">
                      ...
                      <div class="panel-btn" data-v-4b094fcc="">
                        <svg
                          class="sprite-icon icon-collect"
                          data-v-0f838daa=""
                          data-v-4b094fcc=""
                        >
                          <use
                            xlink:href="#icon-collect"
                            data-v-0f838daa=""
                          ></use>
                        </svg>
                        <div
                          class="collect-popover"
                          data-v-d0b73df6=""
                          data-v-4b094fcc=""
                        >
                      ...
                      <div class="share-btn panel-btn" data-v-4b094fcc="">
                        <svg
                          class="sprite-icon icon-share"
                          data-v-0f838daa=""
                          data-v-4b094fcc=""
                        >
                          <use
                      ...
                      <span class="tooltip" data-v-4b094fcc="">
                        <div
                        ...
                        <span class="byte-tooltip__wrapper">
                          <div class="panel-btn" data-v-4b094fcc="">
                            <svg
                              class="sprite-icon icon-immerse"
                              data-v-0f838daa=""
                              data-v-4b094fcc=""
                            >
                              <use
      ...
      <div class="right-part">
        <div class="right_nav">
          <div class="author_box">
            <div class="author_content">
              <a class="firstline">
                ...
                <div class="info_box">
                  <div class="id">
                    <div class="name">掘金酱</div>
                    <span class="level">
                      <img src="../../../第二页/创作等级.png" alt="创作等级" />
                      <span class="none_level">创作等级</span>
                    </span>
                  </div>
                  <div class="discribe">❤首席客服君 @ 掘金</div>
                  <span class="none_discribe">❤首席客服君 @ 掘金</span>
                </div>
              </a>
          ...
          <div class="QR_box">
            <div class="app_ad">
              ...
              <div class="QR_content">
                <div class="head_line">下载稀土掘金APP</div>
          ...
          <div class="relative_box">
            <div class="relative_title">相关文章</div>
            <div class="relative_body">
              <div class="relative_list">
                <a class="rlist_a" href="#">
                  <div class="rlist_content">
                    【中奖公示】8月更文挑战落幕，快来看看你有没有中奖🎁
                  </div>
                  <div class="none_rlist">
                    【中奖公示】8月更文挑战落幕，快来看看你有没有中奖🎁
                  </div>
                  <div class="rlist_conmmed">34点赞&nbsp;&nbsp;35评论</div>
                </a>
                <a class="rlist_a" href="#">
                  <div class="rlist_content">
                    【中奖公示】30天更文挑战落幕，77700元奖品疯狂派送中🎁
                  </div>
                  <div class="none_rlist">
                    【中奖公示】30天更文挑战落幕，77700元奖品疯狂派送中🎁
                  </div>
                  <div class="rlist_conmmed">46点赞&nbsp;&nbsp;41评论</div>
                </a>
              </div>
            </div>
          </div>
          <div class="relative_box">
            <div class="relative_title">目录</div>
            <div class="relative_body">
              <div class="relative_list">
                <a class="rlist_a" href="#">
                  <div class="rlist_content">
        ...
        <div class="catalogue">
          ...
          <ul v-for="(item, index) in catalog" :key="index">
            <li
              :key="item.id"
              :style="{ paddingLeft: item.level * 22 - 44 + 'px' }"
            >
              <a
                :href="'#' + item.id"
                :class="currentTitle.id === item.id ? 'active' : 'test'"
              >
                {{ item.title }}
              </a>
            </li>
