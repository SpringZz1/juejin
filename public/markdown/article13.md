...
本篇文章是全部采用的[`<script setup>`](https://staging-cn.vuejs.org/api/sfc-script-setup.html)这种组合式API写法，相对于选项式来说，组合式API这种写法更加自由，具体可以参考[Vue文档](https://staging-cn.vuejs.org/guide/introduction.html#api-styles)对两种方式的描述。
...
![demo.gif](https://p9-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/b3bef6a9b44f4d85a2b1ed81ef521d22~tplv-k3u1fbpfcp-watermark.image?)

上图中，*列表*和*输入框*分别是父子组件，根据不同传值方式，可能谁是父组件谁是子组件会有所调整。
...
[Vuex](https://vuex.vuejs.org/zh/)和[Pinia](https://pinia.vuejs.org/)是Vue3中的状态管理工具，使用这两个工具可以轻松实现组件通信，由于这两个工具功能比较强大，这里就不做展示了，具体可以查阅文档
